...
<body><div>
<img src="/~jadrn000/PROJ3_IMAGES/stocking.png" alt="Christmas stocking" id="stocking" />
<img src="/~jadrn000/PROJ3_IMAGES/rudolph.gif" alt="Rudolph" id="rudolph" />
...
while(my @row=$sth->fetchrow_array()) {
    print "\t<tr>\n";
    my $pic = "/~jadrn000/PROJ3_IMAGES/".$row[0].".jpg";
